...
<html lang="en">
  ...
  <body>
    ...
    <div class="mainBody">
                 <h1><center style="color:white;margin-top: 5rem;;">Hotels Available</center></h1>
...
?>
              <div class="grid-item card-group" style="max-width: 400px;">
                                <div class="card" style="background-color:rgba(252, 252, 252, 0.132);">
                                    <?php echo "<img class='card-img-top' src='../..".$row[9]."' alt='...' style='max-height:400px;'>" ?>
                                    <div class="card-body">
                                    <h5 class="card-title">
                                    ...
                                    <div class="card-footer">
                                        <center>
                                        <large class="text-light" style=" font-weight: 700;"> <?php echo"".$row['priceprpn']?> Rs</large>
                                        </center>
                                    </div>
                                    <div class="card-footer">
                                        <center>
                                        <?php echo "<a href='viewHotelDetails.php?hotelid=".$row[0]."'>View More</a>"?>
                                        ...
                                        <?php 
                                              if(isset($_SESSION['userType'])===true)
                                              {
                                                if($_SESSION['userType']!=='admin')
                                                {
                                                  echo "<a href='BookHotel.php?hotelid=".$row[0]."'>Book Now</a>";
                                                } 
                                                else{
                                                  echo "<a >Book Now</a>";
                                                }
