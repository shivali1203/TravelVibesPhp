...
?>
            ...
            <div class="right-Data">
                ...
                <div class="detail-info">
                    ...
                    <div class="low-info">
                        ...
                        <form action="BookHotel.php?hotelid=<?php echo "".$row[0]; ?>" method="post" enctype="multipart/form-data">
                              <?php 
                              if(isset($_SESSION['userType'])===true)
                              {
                                if($_SESSION['userType']!=='admin')
                                {
                                    ...
                                    <?php
                                      ...
                                      ?>
                                        <label disabled for="submit">Book Now</label>
                                        <input hidden id="submit" name="submit" type="submit" value="submit" disabled/>
                                    <?php
                                  }
                              }
                              else{
        ...
        <?php } ?>
                                     ...
                                     <!--     FOOTER       -->
 <footer class="footer-section" style="width:100vw;">
    <br><br><br>
    <div class="topFooter">
      <div class="titles">
        <img src="../../assets/Images/MainPage/logo.png" class="logo" alt="AirPlane Logo" />
