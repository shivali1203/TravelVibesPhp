        ...
        <div class="table-section ">
                <table class="table table-striped  table-bordered table-responsive-sm table-responsive-md table-responsive-lg table-dark table-image">
                    ...
                    <tr>
                        ...
                        <th style="vertical-align:middle;text-align:center;" scope="col">Features</th>
                        <th style="vertical-align:middle;text-align:center;" scope="col">Price/Ticket</th>
                        <th style="vertical-align:middle;text-align:center;" scope="col">Tickets Available</th>
                        <th style="vertical-align:middle;text-align:center;" scope="col">Mode of Transportation</th>
                        <th style="vertical-align:middle;text-align:center;" scope="col">Travel Starts On</th>
                        <th style="vertical-align:middle;text-align:center;" scope="col">Travel Ends On</th>
                        <th style="vertical-align:middle;text-align:center;" scope="col">Package Creation Date</th>
                    ...
                    <?php
                      ...
                      while ($row = mysqli_fetch_array($conSql)) {
                        ...
                        echo "      <td style='vertical-align:middle;text-align:center;'> 
                                                              <a href='viewPackageDetails.php?packageId=".$row[0]."' class='btn btn-danger my-btn'>View Details</a>  
                                                              <a href='updatePackageDetails.php?packageId=".$row[0]."' class='btn btn-danger my-btn'>Update Details</a>  
                                                              <a href='../../model/deletePackageDetails.php?packageId=".$row[0]."' class='btn btn-danger my-btn '>Delete Details</a></td>";
                       echo " </tr>";
