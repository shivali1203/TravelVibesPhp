    ...
    <div class="header-absoute">
      ...
      <div class="mainBody">
            <div class="form__align">
                ...
                <form class="rightForm" action="../../model/addHotel.php" method="post" enctype="multipart/form-data">
                        <div class="form-mainSection" >
                          <div>
                                ...
                                <input type="number" min="0" max="5" name="star" placeholder="Star Ratings" > 
                          </div>
                              <div>
