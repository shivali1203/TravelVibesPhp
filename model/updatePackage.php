...
include '../constants/constants.php';
    ...
    if (isset( $_POST['createPackage'] ) )
    {
        ...
        $features=htmlspecialchars($_POST['features']);
            ...
            // SQL ADDED THE DATA
            $sql = "update ".$packageTable." set ".
            $apckageName." = '".$name."' ,".
            $packageState." = '".$state."' ,".            
            $packagePrice." = '".$price."' ,".            
            $ModelOfTransport." = '".$mot."' ,".            
            $packageDefinition." = '".$features."' , ".            
            $ticketAvailable." = '".$ticketsAvail."' , ".            
            $packageStartDate." = '".$startDate."' , ".            
            $packageEndDate." = '".$endDate."' where packageid = ".$id;            
                    ...
                    if($check !== false && $Catch===false)          // image is adde by the user and we have to add it into the DB
                    {
                        ...
                        if (!file_exists($target_file)) {                          // echo "<br >Sorry, file already exists.";
                            ...
                            {                 
                                ...
                                echo "<script>";
                                echo "alert('ERROR : Image was unable to save  in DB , please update Package again !!');";
                              echo "window.location.replace('../view/AdminSection/updatePackageDetails.php?packageId=".$id."')"; //Redirects the user with JavaScript
                                echo "</script>";
                                die();
                                }
                            }
                                ...
                                echo "<script>";
                                echo "alert('ERROR : Image was unable to save , please update Package again !!');";
                                echo "window.location.replace('../view/AdminSection/updatePackageDetails.php?packageId=".$id."')"; //Redirects the user with JavaScript
                                echo "</script>";
                                die();
                            }
...
//   if not added image than  do nothing
                    }
